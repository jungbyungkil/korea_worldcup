...
export const SOUTH_AFRICA_MATCH_HOOKS_KO = [
  "**[종료] 최종 스코어: 🇰🇷 대한민국 0 - 1 🇿🇦 남아프리카 공화국** — 3차전 패배. 조별리그 **1승 2패(3점) 탈락 확정**.",
  "남아공의 선제골에 한국이 끝내 만회골을 넣지 못하고 0-1 패배. **조별리그 A조 3위** 마감.",
  "3위지만 희망은 있다 — 2026 월드컵은 **12개 조 3위 중 상위 8팀**도 32강에 진출. 한국(3pts, GD -1)의 와일드카드 가능성 확인 중.",
] as const;
